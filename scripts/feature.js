 ...
 function signupForm() {
            document.getElementById('suf').removeAttribute('style');
            document.getElementById('sif').setAttribute('style', 'display:none');
 }
    ...
    if (user) {
        ...
        db.on('value', function (users) {
            ...
            if (flag === false) {
                ...
                document.getElementById('myprofile').innerHTML = `<div class="col-7 col-sm-12 col-md-12">
                                                                             <img src="${user.photoURL}" id="mi" class="rounded-circle profilepic" />
                                                                         </div>
                                                                         <div class="un text-center" id="un">
                                                                             <h5>  ${user.displayName}</h5>
                                                                         </div>
                                                                         <div class="em text-center" id="em">
                                                                             <h5>  ${user.email}</h5>
                                                                         </div>`
                ...
                firebase.database().ref('users').child(friendKey).on('value', function (data) {
                    ...
                    document.getElementById('lstChat').innerHTML += `<li class="list-group-item list-group-item-action" onclick="StartChat('${data.key}', '${user.name}', '${user.photoURL}')">
                            <div class="row">
                                ...
                                <div class="col-md-10" style="cursor:pointer;">
                                    <div class="name">${user.name}</div>
                                    <div class="under-name">Available</div>
                                </div>
                            </div>
                        </li>`;
                });
...
function loadAllEmoji() {
    ...
    for (var i = 128512; i <= 129488; i++) {
        emoji += `<a href="#" style="font-size: 25px; background-color: #ddd" onclick="getEmoji(this)">&#${i};</a>`;
    }
